...
import { getCriteria, getRootCriteria, patchCriteria, postCriteria } from "../handlers/criteria-handler.js";
...
criteriaRoute.get('/', AuthorizationMiddleware(["Admin", "User", "Asesor"]), getRootCriteria)
criteriaRoute.get('/:id', AuthorizationMiddleware(["Admin", "User", "Asesor"]), getCriteria)
